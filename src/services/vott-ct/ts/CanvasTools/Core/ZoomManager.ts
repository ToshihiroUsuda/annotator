...
export class ZoomManager {
     ...
     */
    private static instance: ZoomManager | undefined
    ...
    private constructor(
        ...
        this.callbacks = zoomCallbacks || ({} as IZoomCallbacks)
    ...
    public updateZoomScale(zoomType: ZoomDirection): ZoomData {
        ...
        if (
            updatedZoomScale >= this.minZoomScale &&
            updatedZoomScale <= this.maxZoomScale
        ) {
    ...
    public deleteInstance(): void {
        if (ZoomManager.instance) {
            ZoomManager.instance = undefined
        }
    }
}
