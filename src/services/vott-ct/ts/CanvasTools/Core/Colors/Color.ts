...
export class Color {
  ...
  private xyzColor: XYZColor | undefined;
  private labColor: LABColor | undefined;
  private hslColor: HSLColor | undefined;
  ...
  constructor(
    ...args:
      | [SRGBColor | RGBColor | HSLColor | XYZColor | LABColor | string]
    ...
    if (args.length === 1) {
      ...
      if (c instanceof SRGBColor) {
        ...
        throw new Error(
          "Wrong arg type. Expected one of the '***Color' types."
        );
      }
      ...
      if (
        ...
        throw new Error(
          "Wrong arg type. Expected 3 args of the 'number' type."
        );
      }
    } else {
