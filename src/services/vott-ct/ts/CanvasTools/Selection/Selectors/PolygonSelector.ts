...
export class PolygonSelector extends Selector {
    ...
    private buildUIElements() {
        ...
        this.nextPoint = this.paper.circle(
            0,
            0,
            PolygonSelector.DEFAULT_SELECTOR_RADIUS
        )
            ...
            },
            {
                ...
                listener: (
                    ...
                    if (!this.isCapturing) {
                        ...
                        if (
                            typeof this.callbacks.onSelectionBegin ===
                            'function'
                        ) {
                ...
                listener: (
                    ...
                    window.requestAnimationFrame(() => {
                        ...
                        if (this.lastPoint != null && this.isDrawing) {
                            const threshold =
                                PolygonSelector.THRESHOLD_DISTANCE_FOR_ADD_POINT
                            const distance = p.squareDistanceToPoint(
                                this.lastPoint
                            )
    ...
    private addPoint(x: number, y: number) {
        ...
        const point = this.paper.circle(
            x,
            y,
            PolygonSelector.DEFAULT_POINT_RADIUS
        )
