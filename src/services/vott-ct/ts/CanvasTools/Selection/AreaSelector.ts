...
import {
    ISelectorSettings,
    SelectionMode,
} from '../Interface/ISelectorSettings'
...
export class AreaSelector {
    ...
    public resize(width: number, height: number): void {
        if (width !== undefined && height !== undefined) {
            ...
            this.boundRect.resize(
                this.parentNode.width.baseVal.value,
                this.parentNode.height.baseVal.value
            )
        }
     ...
     */
    public setSelectionMode(settings: ISelectorSettings): void
    public setSelectionMode(settings: ISelectorSettings | SelectionMode): void {
        ...
        if (
            this.selectorSettings === undefined ||
            this.selectorSettings.mode !== selectionSettings.mode
        ) {
            this.disable()
            this.selectorSettings = selectionSettings

            if (this.selectorSettings.mode === SelectionMode.NONE) {
                this.selector = null as unknown as Selector
                return
                ...
                if (template !== undefined) {
                    ...
                    this.rectCopySelector.setTemplate(
                        AreaSelector.DefaultTemplateSize
                    )
                }
    ...
    private buildUIElements() {
        ...
        this.rectSelector = new RectSelector(
            this.parentNode,
            this.paper,
            this.boundRect,
            this.callbacks
        )
        this.rectCopySelector = new RectCopySelector(
            this.parentNode,
            this.paper,
            this.boundRect,
            new Rect(0, 0),
        ...
        this.polylineSelector = new PolylineSelector(
            this.parentNode,
            this.paper,
            this.boundRect,
            this.callbacks
        )
        this.polygonSelector = new PolygonSelector(
            this.parentNode,
            this.paper,
            this.boundRect,
            this.callbacks
