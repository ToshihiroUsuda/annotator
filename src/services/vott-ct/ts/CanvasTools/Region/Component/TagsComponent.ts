...
export abstract class TagsComponent extends RegionComponent {
     ...
     */
    protected primaryTagNode: Snap.Element | null = null

    /**
     * The grouping element for secondary tags.
     */
    protected secondaryTagsNode: Snap.Element | null = null
     ...
     */
    protected styleSheet: CSSStyleSheet | null = null

    /**
     * The settings for redrawing tags.
     */
    protected tagsUpdateOptions: ITagsUpdateOptions | undefined
    ...
    constructor(
        ...
        super(paper, paperRect, regionData, {
            ...
            onManipulationEnd: () => {},
            onChange: () => {},
            onManipulationLockRequest: () => {},
            onManipulationLockRelease: () => {},
        })
    ...
    public updateTags(tags: TagsDescriptor, options?: ITagsUpdateOptions) {
        ...
        const showBackground =
            options !== undefined ? options.showRegionBackground : true
     ...
     */
    protected abstract initStyleMaps(tags: TagsDescriptor): void

    /**
     * Rebulds the tags elements. Should be redefined in child classes.
     */
    protected abstract rebuildTagLabels(): void
    ...
    protected applyStyleMaps(showRegionBackground: boolean = true) {
        ...
        if (this.tags && this.tags.primary !== undefined && this.styleSheet) {
            window.requestAnimationFrame(() => {
                const sm = showRegionBackground
                    ? this.styleMap
                    : this.styleLightMap
                for (const r of sm) {
                    if (this.styleSheet) {
